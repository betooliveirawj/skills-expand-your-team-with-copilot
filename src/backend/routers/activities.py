...
def get_activities(
    ...
    - difficulty: Filter by difficulty level ('Beginner', 'Intermediate', 'Advanced'). Use 'all' to show only activities available for all levels (no specific difficulty assigned).
    """
